...
'''for c in classifiers:
     ...
     evaluate(clf, my_dataset, features_best, features, labels, 50, c['params'])
'''

clf = Pipeline(steps=[("scaler", scaler), ("skb", SelectKBest(k='all')), ("clf", RandomForestClassifier())])
